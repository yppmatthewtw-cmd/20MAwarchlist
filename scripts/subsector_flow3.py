#!/usr/bin/env python3
"""Sub-sector money-flow scoring — R3.00 engine (111 sub-sectors of the R2 heat-map workbook).
...
json.dump(out, open(os.environ.get("OUT_JSON", f"{SCR}/sub3/flow3.json"), "w"), ensure_ascii=False)
print("\nTOP 12 inflow:")
for r in live[:12]:
