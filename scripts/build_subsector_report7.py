#!/usr/bin/env python3
"""Sub-Sector 資金流向 Watchlist R7.00 — 111 sub-sectors x 5 sessions of money-flow scores (Yahoo second source).
...
另有 {TSV} 隻嘅最新一日只有 Yahoo 尾段價格，B 已設為中性。<br>
...
html_doc = f"""<title>Sub-Sector 資金流向 Watchlist R7</title>
<style>{css}</style>
<div class="wrap">
