#!/usr/bin/env python3
"""Sub-Sector 資金流向 Watchlist R10.00 — 111 sub-sectors x 5 sessions of money-flow scores (Yahoo second source).
...
html_doc = f"""<title>Sub-Sector 資金流向 Watchlist R10</title>
<style>{css}</style>
<div class="wrap">
