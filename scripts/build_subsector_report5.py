#!/usr/bin/env python3
"""Sub-Sector 資金流向 Watchlist R5.00 — 111 sub-sectors x 5 sessions of money-flow scores (Yahoo second source).
...
兩者共同收盤中位偏差 {XN.get("median_pct", 0):.4f}%。<br>
...
html_doc = f"""<title>Sub-Sector 資金流向 Watchlist R5</title>
<style>{css}</style>
<div class="wrap">
