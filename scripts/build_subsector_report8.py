#!/usr/bin/env python3
"""Sub-Sector 資金流向 Watchlist R8.00 — 111 sub-sectors x 5 sessions of money-flow scores (Yahoo second source).
...
依據係 9/10 結算後 Yahoo 日線成交量與鏡像 403 隻完全一致。<br>
...
html_doc = f"""<title>Sub-Sector 資金流向 Watchlist R8</title>
<style>{css}</style>
<div class="wrap">
