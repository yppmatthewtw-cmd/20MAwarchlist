#!/usr/bin/env python3
"""Sub-Sector 資金流向 Watchlist R6.00 — 111 sub-sectors x 5 sessions of money-flow scores (Yahoo second source).
...
最新一日嘅成交量喺首次發佈後仍會修訂（實測抽樣 256 隻有 255 隻被改，11% 改動 &gt;5%），故本表只喺兩邊都有嗰日先當定案。<br>
...
html_doc = f"""<title>Sub-Sector 資金流向 Watchlist R6</title>
<style>{css}</style>
<div class="wrap">
