#!/usr/bin/env python3
"""Sub-Sector 資金流向 Watchlist R9.00 — 111 sub-sectors x 5 sessions of money-flow scores (Yahoo second source).
...
未結算日嘅收盤價準確，成交量之後仍會修訂；實測對 5 日排名嘅影響 |Δ名次| 中位 0、最大 3。<br>
...
html_doc = f"""<title>Sub-Sector 資金流向 Watchlist R9</title>
<style>{css}</style>
<div class="wrap">
