...
d = pickle.load(open(f"{SCRATCH}/series7b.pkl", "rb"))
...
def row(sym, q):
    ...
    return {
        ...
        "mcap": m.get("mcap", 0.0), "tier": cap_tier(m.get("mcap", 0.0)),
...
json.dump(out, open(f"{SCRATCH}/screen_results7.json", "w"), ensure_ascii=False)
