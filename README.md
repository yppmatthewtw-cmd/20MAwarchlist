...
| R5.00 | R4 分層版：每個時間框拆成 **大型股(≥$10B)／中型股($2B–$10B)／小型股(<$2B)** 三個獨立 top 50 榜，共 12 個分層頁＋總表（217 隻不重複）；新增市值欄（可排序）、**🔥 熱炒 news-driven 催化劑獨立欄**＋每頁頂部可點擊橫幅 |
...
8. **市值分層（R5）**：大型股 ≥$10B、中型股 $2B–$10B、小型股 <$2B（含通過流動性門檻的微型股）。
   每個時間框各自分三層、每層獨立取 top 50，避免細價股被大價股擠走；三層合資格數之和等於該時間框原總數（已驗證守恆）。
